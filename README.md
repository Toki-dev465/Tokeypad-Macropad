# Important Note
My PCB design has a slight error as the 5V on MC is connected to the VCC of OLED. Using 5V may or may not work. It could potentially damage the microcontroller and the OLED. 
